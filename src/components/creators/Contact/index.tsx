...
const CreatorContact = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    youtube: "",
    instagram: "",
    message: "I'm interested in joining Eva as a creator!",
  });
          ...
          <div className="w-full px-4 lg:w-4/12 xl:w-4/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[250px]">
                ...
                <p className="mt-6 mb-8 pb-12 text-[#545A2B] font-light pr-12">Just a quick 30-minute chat to understand your goals as a creator and see how Eva can help you. Fill out the form and we’ll be in touch soon!</p>
              </div>
            </div>
          </div>
