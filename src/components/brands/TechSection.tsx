          ...
          <div className="relative z-10 h-full flex items-center p-6 md:p-12">
            <div className="flex flex-col items-start gap-4 md:gap-8 w-full">
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-instrument-serif font-normal text-white w-full md:w-1/3">
                Launch your next campaign with Eva
              </h2>
              <button onClick={() => window.location.href = '/brands/contact'} className="mt-4 md:mt-8 bg-primary text-darkgreen text-lg md:text-xl px-8 md:px-10 py-3 md:py-4 rounded-full hover:bg-opacity-90 transition-colors duration-200 w-fit">
                Learn More
              </button>
            </div>
          </div>
...
export default BrandTechSection; 