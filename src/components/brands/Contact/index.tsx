...
const BrandContact = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    message: "I'm interested in starting an infuencer campaign with Eva!",
  });
          ...
          <div className="w-full px-4 lg:w-4/12 xl:w-4/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[250px]">
                ...
                <p className="mt-6 mb-8 pb-12 text-[#545A2B] font-light pr-12">Just a quick 30-minute chat to understand your goals as a brand and see how influencer marketing can help you. Fill out the form and we’ll be in touch soon!</p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <form action="https://formbold.com/s/3wGv8" method="POST">
                ...
                <div className="mb-0">
                  ...
                  <p className="mt-6 text-darkgreen">We'll be in touch within the day to schedule your call.</p>
                </div>
              </form>
            </div>
          </div>
