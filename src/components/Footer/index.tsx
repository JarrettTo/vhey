...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#101517] pt-20 lg:pt-[100px] border-[1px] border-primary px-8 md:px-0"
      data-wow-delay=".15s"
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
            ...
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <a
                  ...
                  href="/#"
                  className="px-3 text-primary hover:text-white"
                >
                  <svg
                    width="22"
                    height="22"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-bold text-primary">
                About Us
              </h4>
              <ul>
                <li>
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <a
                    href="/#"
                    className="px-3 font-light text-primary hover:text-white hover:underline"
                  >
                    Privacy policy
                  </a>
                  <a
