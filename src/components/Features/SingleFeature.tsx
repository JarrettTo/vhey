...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div className="w-full px-8 lg:w-3/7 xl:w-7/14 py-8 bg-tertiary rounded-3xl">
      <div className="wow fadeInUp group rounded-3xl" data-wow-delay=".15s">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary px-3 py-3">
