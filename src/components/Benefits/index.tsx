      ...
      <div className="w-full px-12 flex flex-col items-center">
        <div className="w-2/2 flex flex-col items-center text-primary">
          <h1 className="text-3xl mb-12 text-center lg:flex lg:justify-center lg:items-center leading-relaxed">
            ...
            <span className="">'s AI-powered experts help trades Businesses...</span>
          </h1>
        </div>
        ...
        <div className="w-2/2 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex flex-col items-center px-12">
            ...
            <h1 className=" text-5xl md:text-6xl font-bold"><LinearGradient className="font-bold" gradient={['to left', '#B7CF0E,#D7E47D']}>$40,000</LinearGradient></h1>
            <p className="text-xl text-primary font-light">yearly</p>
          </div>
          <div className="flex flex-col items-center px-12">
            <p className="text-xl text-primary font-light">scale operations by</p>
            <h1 className="text-5xl md:text-6xl font-bold"><LinearGradient className="font-bold" gradient={['to left', '#B7CF0E,#D7E47D']}>31%</LinearGradient></h1>
            <p className="text-xl text-primary font-light">yearly</p>
          </div>
          <div className="flex flex-col items-center px-12">
            <p className="text-xl text-primary font-light">take back over</p>
            <h1 className="text-5xl md:text-6xl font-bold text-center"><LinearGradient className="font-bold" gradient={['to left', '#B7CF0E,#D7E47D']}>1000+ hours</LinearGradient></h1>
            <p className="text-xl text-primary font-light">yearly</p>
          </div>
        </div>
      </div>
